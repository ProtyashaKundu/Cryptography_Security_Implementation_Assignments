...
int main(void) 
{
    ...
    /* ---- message ---- */
    const char* msg="Success is 100% 0%, 0% 100%, and the Fourier Series";
...
Original  (109 bytes): All my years to this moment.All my roads to this wall.All my words to this silence.All my pride to this fall.
Decrypted (109 bytes): All my years to this moment.All my roads to this wall.All my words to this silence.All my pride to this fall.
Round trip OK.
===================================================
RSA block size:                256 bytes
Encrypt: avg cycles            32458.00
Encrypt: cycles/byte (block)   126.79 CPB
Decrypt: avg cycles            1056884.53
Decrypt: cycles/byte (block)   4128.46 CPB
===================================================
...
===================================================
RSA block size:                256 bytes
Encrypt: avg cycles            29497.81
Encrypt: cycles/byte (block)   115.23 CPB
Decrypt: avg cycles            1049607.34
Decrypt: cycles/byte (block)   4100.03 CPB
===================================================
