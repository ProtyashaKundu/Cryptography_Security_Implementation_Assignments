...
int main()
{
    ...
    const uint64_t ITERATIONS = 100000000; // 100 million iterations (12.8 GB generated) otherwise for smaller iteration execution time is 0.0000//  suggested by claude
    ...
    double throughput_gbps = (total_bytes / (1024.0 * 1024.0 * 1024.0)) / total_time_sec;

    printf("=== ChaCha20 AVX2 Performance Benchmark ===\n");
    printf("Total Processed Data : %lu MB\n", total_bytes / (1024 * 1024));
    printf("Total Execution Time : %.4f seconds\n", total_time_sec);
    printf("Total Clock Cycles   : %lu cycles\n", total_cycles);
    printf("Cycles Per Byte (CPB): %.2f cpb\n", cycles_per_byte);
